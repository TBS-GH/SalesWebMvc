...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //aqui fizemos a injeção de depedencia, ou seja, quando um SeedingService for criado
        //automaticamente ele vai receber uma instancia do context também
        public SeedingService (SalesWebMvcContext context)
        {
            _context = context;
        }

        //essa operação vai ser responsável por popular a minha base de dados
        public void seed()
        {
            //fazendo um teste se existe um dado na minha base de dados
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; //aqui é pra cortar a execução do método -- DB has been seeded
            }
            ...
            Seller s3 = new Seller(3, "Alex Grey", "AlexGray@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "Martha@gmail.com", new DateTime(1938, 11, 30), 3000.0, d4);
            ...
            //adicioando os objentos no DB. o método AddRange(), permite adicionar varios objetos de uma só vez
            ...
            //para efetivar essas alterações devemos usar o comando abaixo, ele salva e 
